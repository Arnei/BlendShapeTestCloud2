...
[CustomEditor(typeof(InteractiveFacialAnimationV2Controller))]
public class InteractiveFacialAnimationV2ControllerEditor : Editor
{
    InteractiveFacialAnimationV2Controller m_Target;
    ...
    {
        m_Target = (InteractiveFacialAnimationV2Controller)target;
